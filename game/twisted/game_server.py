...
def main(args):
    ...
    from texas.game.checkers.general_manager import CheckRoomInfoThread
    from texas.game.twisted.factory import TexasFactory
    from texas.game.web_views.views import Api
    ...
    check_room_info_thread = CheckRoomInfoThread(factory)
    check_room_info_thread.setDaemon(True)
    check_room_info_thread.start()
